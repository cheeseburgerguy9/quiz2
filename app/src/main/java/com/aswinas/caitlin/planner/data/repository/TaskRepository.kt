package com.aswinas.caitlin.planner.data.repository

import com.aswinas.caitlin.planner.data.db.StudyRecordDao
import com.aswinas.caitlin.planner.data.db.TaskDao
...
class TaskRepository(
    ...
    suspend fun replaceAllStudyRecords(records: List<StudyRecord>) {
        studyDao.clearAll()
        studyDao.insertAll(records)
    }
}
